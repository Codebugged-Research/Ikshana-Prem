...
from CustomObjectDetectionImage import Custom_Object_Detection_Image
from CustomObjectDetectionVideo import Custom_Object_Detection_Video
from CustomObjectDetectionStream import Custom_Object_Detection_Stream
...
def Change_Canvas(window):
		...
		width = 77,
		height = 78)
		window.bind('<Escape>', lambda e: exit_func())
		window.mainloop()